...
public class FactServlet extends HttpServlet {
	...
	private static final String jsFile = "/Users/DreCillaDero/eclipse-workspace/test1/src/facts/facts.js";
	private static final String xmlFile = "/Users/DreCillaDero/eclipse-workspace/test1/WebContent/WEB-INF/data/facts.xml";
	private static final String thisServlet = "http://localhost:8080/test1/";
	...
	private void printBody(PrintWriter out) throws ServletException, IOException{
		...
		//box to enter a new fact
		out.println("    <tr>");
		out.println("      <th>Enter New Fact :</th>");
		out.println("      <td>");
		
		out.println("    <tr>");
		out.println("      <th>Fact :</th>");
		out.println("      <td>");
		out.println("        <input type=\"text\" id=\"addFact\" name=\"addFact\" value=\"\" size=\"50\" />");
		out.println("      </td>");
		out.println("    </tr>");
	...
	//
	private void printNewFact(PrintWriter out, String addFact) {
